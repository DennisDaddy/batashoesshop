	   ...
	   if($_POST["attempts"]<3)
	     {	
  		...
  		if(($password==$row['pass'])&& ($username==$row['username']))
				...
				$Login="YES";    		
	 			mysqli_query($con,"UPDATE administrators SET logged='".$Login."' WHERE username='".$username."'");	 
	 			 $username = $_POST["username"];
				...
				// header("Location:controlpanel.php");
			      ...
			      mysqli_query($con,"UPDATE administrators
  			      SET status=2
...
<div id="footer">
<P align="center">&copy;<?php echo date("Y");?> -All Rights Reserved -By Dennis private Developer</p>
