...
mysqli_query($con,"update iorders set completed='YES' WHERE order_no='".$_REQUEST['orderno']."'");}
...
<div id="footer">
<P align="center">&copy;<?php echo date("Y");?> -All Rights Reserved -By Dennis private Developer|   <A HREF="administration.php">Admin Login</A></p>
