...
$con =mysqli_connect("localhost","root","","batashoedb");
 ...
 $itemnumber=NULL;
	...
	mysqli_query($con,"INSERT INTO $cartname( `itemnumber`)
              VALUES('$itemnumber')");
	...
	while($row = mysqli_fetch_array($rs))
	 {	     	
	 $rs1=mysqli_query($con,"SELECT * FROM item   where itemnumber=".$row['itemnumber']."");	 
	...
	{$q=1;}	
	  ...
	  $total=$total+$subtotal;
	    ...
	    mysqli_query($con,"update $cartname set 
	...
	mysqli_query($con,"CREATE TABLE`$con`.`$cartname` 
...
<div id="footer">
<P align="center">&copy;<?php echo date("Y");?> -All Rights Reserved -By Dennis private Developer</a></p>
